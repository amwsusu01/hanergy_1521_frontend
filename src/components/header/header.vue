...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            childClick() {
               /* this.$set( this.sidebar,'childValue', true);
                this.$set( this.sidebar,'systemValue', false)*/
