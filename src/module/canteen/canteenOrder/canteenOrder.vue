<template>
    <div >
                ...
                <el-form-item label="查询时间:" prop="date">
                    <el-col :span="8" style="width:120px;">
                        <el-date-picker size="mini" type="month"
                                        ...
                                        @change = "changeTime(form.date.date1)"
                    ...
                    <el-col style="width:120px;display: inline-block">
                        <el-date-picker
                                ...
                                :placeholder=initTime
                                @change = "changeEndTime(form.date.date2)"
                                :picker-options="pickerOptions"
                                v-model="form.date.date2" style="width: 100%;">
                        </el-date-picker>
                    </el-col>
                </el-form-item>
        ...
        <div>
            <div id="assemblyChart" class="relationShipChart"></div> <!--<div class="download"></div>-->
