        ...
        <div class="box">
            <el-form :inline="true" ref="form" class="contain" size="mini">
                <el-form-item label="负责人:" size="mini" prop="konggujitua">
                    <el-select v-model="form.approverList" @change="selectChange" style="width: 251px;" multiple
                ...
                <el-form-item label="招聘负责人:" size="mini" prop="konggujitua">
                    <el-select v-model="form.recruiterList" @change="selectChange" style="width: 251px;" multiple
                               placeholder="无限制" collapse-tags size="mini">
                ...
                <el-form-item label="集团:" size="mini" prop="konggujitua">
                    <el-select v-model="form.buoncodeList" @change="selectChange" style="width: 251px;" multiple
                               placeholder="无限制" collapse-tags size="mini">
                ...
                <el-form-item label="部门事业部:" size="mini" prop="konggujitua">
                    <el-select v-model="form.divicodeList" @change="selectChange" style="width: 251px;" multiple
                               placeholder="无限制" collapse-tags size="mini">
                ...
                <el-form-item label="简历时间:" prop="date">
                    <el-col :span="8" style="width:122px;">
                        <el-date-picker v-model="salaryTime.value1" value-format="yyyy-MM-d" placeholder="选择日期时间"
                    ...
                    <el-col style="width:122px;display: inline-block">
                        <el-date-picker v-model="salaryTime.value2" value-format="yyyy-MM-d" placeholder="选择日期时间"
                ...
                <el-form-item label="offer时间:" prop="date">
                    <el-col :span="8" style="width:122px;">
                        <el-date-picker v-model="offerTime.value1" value-format="yyyy-MM-d" placeholder="选择日期时间"
                                        :picker-options="pickerOptionsBeforeOffer" @change="changeTime" size="mini"
                                        style="width: 100%;"></el-date-picker>
                    </el-col>
                    <el-col class="line" :span="1">-</el-col>
                    <el-col style="width:122px;display: inline-block">
                        <el-date-picker v-model="offerTime.value2" value-format="yyyy-MM-d" placeholder="选择日期时间"
                ...
                <el-form-item label="入职时间:" prop="date">
                    <el-col :span="8" style="width:122px;">
                        <el-date-picker v-model="entryTime.value1" value-format="yyyy-MM-d" placeholder="选择日期时间"
                                        :picker-options="pickerOptionsBeforeEntry" @change="changeTime" size="mini"
                                        style="width: 100%;"></el-date-picker>
                    </el-col>
                    <el-col class="line" :span="1">-</el-col>
                    <el-col style="width:122px;display: inline-block">
                        <el-date-picker v-model="entryTime.value2" value-format="yyyy-MM-d" placeholder="选择日期时间"
        ...
        methods: {
            ...
            getSelectData() {
                ...
                this.$api.canteen.getPersonnelFlowSelect(obj).then(res => {
                        /*this.form.approverList = res.approverList, // 负责人
                        this.form.recruiterList = res.recruiterList, // 招聘负责人
                        this.form.hrvpList = res.hrvpList, // hrvp数据
                        this.form.buoncodeList = res.buoncodeList, // 集团
                        this.form.divicodeList = res.divicodeList, // 部门事业部
                        this.form.busUnitList = res.busUnitList // 业务单元*/
