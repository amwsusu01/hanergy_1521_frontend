<template>
    <div class="supplier-receiver-order" v-if="response">
        <el-breadcrumb separator="/" class="order-breadcrumb">
            <el-breadcrumb-item  :to="{ path: '/supplierHistoryOrderDetail'}">>系统安全</el-breadcrumb-item>
            <el-breadcrumb-item  :to="{ path: '/supplierReceiverOrder'}">用户操作记录</el-breadcrumb-item>
        </el-breadcrumb>
        <!--样式在assets/css/order-->
